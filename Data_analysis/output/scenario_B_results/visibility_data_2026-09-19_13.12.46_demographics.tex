...
\hline
Agent Type & Total Agents & Agents in VCA & VCA Penetration (\%) & Overall Visibility (\%) & Overall 95\% CI & VCA Visibility (\%) & VCA 95\% CI & Mean Eye Height (m) & Mean Time in VCA (s) \\ \hline
